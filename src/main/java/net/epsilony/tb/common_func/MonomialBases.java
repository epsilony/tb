...
public class MonomialBases implements BasesFunction {
    ...
    public static double[][] monomials2D(double[] vec, int degree, int diffOrder, double[][] results) {
        ...
        if (null == results) {
            results = new double[WithDiffOrderUtil.outputLength(2, diffOrder)][WithDiffOrderUtil
                    .outputLength(2, degree)];
        }
    ...
    public static double[][] monomials3D(double[] vec, int degree, int diffOrder, double[][] results) {
        ...
        if (null == results) {
            results = new double[WithDiffOrderUtil.outputLength(3, diffOrder)][WithDiffOrderUtil
                    .outputLength(3, degree)];
        }
